...
print("=== Extracting 120 Frames from Directions Video (gemini_generated_video_589fbcb9.mp4) ===")

scene = bpy.context.scene
scene.sequence_editor_create()

video_path = "C:/Projects/wtma_landingPage/gemini_generated_video_589fbcb9.mp4"
strip = scene.sequence_editor.strips.new_movie('DirectionsVid', video_path, channel=1, frame_start=1)
...
out_dir = "C:/Projects/wtma_landingPage/images/directions-sequence"
...
print(f"=== Successfully Extracted {count-1} Directions Frames! ===")
